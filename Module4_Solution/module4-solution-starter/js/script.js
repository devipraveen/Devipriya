...
function buildAndShowHomeHTML (categories) {
  ...
  $ajaxUtils.sendGetRequest(
    ...
    function (homeHtml) {
        ...
        var store=chooseRandomCategory (categories);
        var chosenCategoryShortName =store.short_name;
        chosenCategoryShortName1 = "'" + chosenCategoryShortName + "'";
    ...
    false); // False here because we are getting just regular HTML from the server, so no need to process JSON.
      ...
      //var homeHtmlToInsertIntoMainPage = 
       // buildCategoriesViewHtml(chosenCategoryShortName, categoriesTitleHtml, categoryHtml); 
